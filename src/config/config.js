...
export default {
  ...
  goods: [
    {
      name: 'nuotai',
      text: '良品铺子高端零食 鸡蛋干休闲零食酱香味素食豆腐干小吃238g*1',
      address: '江苏',
      type: '包邮',
      price: '30.00',
      onlinePrice: '26.90',
      cover: './static/images/jidan_01.jpg',
      poster: './static/images/slide01.png',
      color: '#e8e8e8',
      images: [
        './static/images/jidan_01.jpg',
    ...
    {
      name: 'nuotai',
      text: '玉泽皮肤屏障修护保湿霜50g*3瓶组 滋润护肤面霜',
      address: '上海',
      type: '包邮',
      price: '594.00',
      onlinePrice: '446.00',
